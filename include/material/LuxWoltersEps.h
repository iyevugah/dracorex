...
template <bool is_ad>
class LuxWoltersEpsTempl : public RadialReturnCreepStressUpdateBaseTempl<is_ad>
{
public:
  static InputParameters validParams();
  LuxWoltersEpsTempl(const InputParameters & parameters);
...
typedef LuxWoltersEpsTempl<false> LuxWoltersEps;
typedef LuxWoltersEpsTempl<true> ADLuxWoltersEps;
